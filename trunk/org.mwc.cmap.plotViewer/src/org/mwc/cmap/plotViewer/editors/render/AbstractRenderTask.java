...
/**
 * Abstract class for rendering tiles. These can be submitted to a
 * ExecutorService (threadpool) for parallel execution.
 * 
 * @author Jesse
 */
public abstract class AbstractRenderTask implements Callable<RenderTaskResult>
{
	...
	public void setDataProjection(PlainProjection projection)
	{
		...
		this._projection.setName("RenderTask copied project: "
				+ projection.getName());
		this._projection.setRelativeMode(projection.getPrimaryCentred(),
				projection.getPrimaryOriented());

...
public abstract class SWTChart extends PlainChart implements ISelectionProvider
{
	...
	protected transient Renderer _renderer;
			...
			GeoToolsHandler _myProjection)
	{
		...
		_renderer.setTheCanvas(_theCanvas);
		_renderer.setTheLayers(theLayers);
	...
	{
		_theCanvas.redraw(false, rect.x, rect.y, rect.width, rect.height, true);
	...
	public final void update(final Layer changedLayer)
	{
		...
		{
			_renderer.removeImage(changedLayer);
